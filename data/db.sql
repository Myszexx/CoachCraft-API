...
create index if not exists oauth2_provider_application_client_id_03f0cc84_like
    on oauth2_provider_application (client_id varchar_pattern_ops);

create index if not exists oauth2_provider_application_client_secret_53133678
    on oauth2_provider_application (client_secret);

create index if not exists oauth2_provider_application_client_secret_53133678_like
...
create index if not exists oauth2_provider_grant_code_49ab4ddf_like
...
create index if not exists oauth2_provider_accesstoken_token_checksum_85319a26_like
...
create table if not exists players_affilations
(
    id         integer generated by default as identity
        primary key,
