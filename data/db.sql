...
(
    appearance_id serial
        constraint training_squad_pk
            primary key,
    training_id   integer
        constraint training_squad_trainings_id_fk
            references trainings,
    player_id     integer
        constraint training_squad_players_id_fk
            references players
);
