...
class Matches(models.Model):
    home_team = models.ForeignKey('apps.teams.Teams', models.DO_NOTHING, blank=True, null=True)
    home_team_name = models.CharField(max_length=1024, blank=True, null=True)
    away_team = models.ForeignKey('apps.teams.Teams', models.DO_NOTHING, related_name='matches_away_team_set', blank=True, null=True)
...
class MatchEvents(models.Model):
    ...
    player = models.ForeignKey('apps.players.Players', models.DO_NOTHING, blank=True, null=True)
    player2 = models.ForeignKey('apps.players.Players', models.DO_NOTHING, related_name='matchevents_player2_set', blank=True, null=True)
